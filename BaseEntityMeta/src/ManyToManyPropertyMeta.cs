...
namespace BaseEntity.Metadata
{
  ...
  /// </summary>
  public abstract class ManyToManyPropertyMeta : CollectionPropertyMeta, ICascade
  {
    #region Constructors
    ...
    protected ManyToManyPropertyMeta(ClassMeta entity, ManyToManyPropertyAttribute propAttr, PropertyInfo propInfo)
      : base(entity, propAttr, propInfo)
    {
      ...
      if (propType.IsGenericType)
      {
        ...
        if (typeDef != typeof(IList<>) && typeDef != typeof(IDictionary<,>))
        {
          throw new MetadataException(String.Format(
            "Invalid property type [{0}] for [{1}.{2}] : ManyToManyProperty must be of type IList<> or IDictionary<,>!",
      ...
      {
        throw new MetadataException(String.Format(
          "Invalid property [{0}.{1}] : Cannot define ManyToMany property on Component",
          Entity.Name, Name));
      }
    ...
    {
      get { return Cardinality.ManyToMany; }
    }
    ...
    public ICascade FindInverse()
    {
      ...
      foreach (var otherCascade in cascadeList.Where(otherCascade => otherCascade.ReferencedEntity == Entity &&
  ...
  public class MapManyToManyPropertyMeta<T, TKey, TValue> : ManyToManyPropertyMeta
    ...
    where TValue : PersistentObject
  {
    ...
    /// <param name="propAttr"></param>
    /// <param name="propInfo"></param>
    public MapManyToManyPropertyMeta(ClassMeta entity, ManyToManyPropertyAttribute propAttr, PropertyInfo propInfo)
      : base(entity, propAttr, propInfo)
    {
  ...
  /// <typeparam name="T"></typeparam>
  /// <typeparam name="TValue"></typeparam>
  public class ListManyToManyPropertyMeta<T, TValue> : ManyToManyPropertyMeta
    where T : BaseEntityObject
    where TValue : PersistentObject
  {
    /// <summary>
    ...
    /// <param name="propAttr"></param>
    /// <param name="propInfo"></param>
    public ListManyToManyPropertyMeta(ClassMeta entity, ManyToManyPropertyAttribute propAttr, PropertyInfo propInfo)
      : base(entity, propAttr, propInfo)
    {
  ...
  /// <typeparam name="T"></typeparam>
  /// <typeparam name="TValue"></typeparam>
  public class BagManyToManyPropertyMeta<T, TValue> : ManyToManyPropertyMeta
    where T : BaseEntityObject
    where TValue : PersistentObject
  {
    /// <summary>
    ...
    /// <param name="propAttr"></param>
    /// <param name="propInfo"></param>
    public BagManyToManyPropertyMeta(ClassMeta entity, ManyToManyPropertyAttribute propAttr, PropertyInfo propInfo)
      : base(entity, propAttr, propInfo)
    {
      Getter = CreatePropertyGetter<T, IList<TValue>>(propInfo);
      Setter = CreatePropertySetter<T, IList<TValue>>(propInfo);
