...
namespace BaseEntity.Toolkit.Pricers
{
  ///
	...
	///   <see cref="BaseEntity.Toolkit.Models.UniformBasketModel">Uniform Basket Model</see>.</para>
	/// </summary>
	///
	/// <remarks>
	///   This pricer is based on direct calculation of the loss distribution.
	/// </remarks>
	///
	/// <example>
	...
	///   SyntheticCDOUniformPricer pricer =
	///     new SyntheticCDOUniformPricer( asOf,                      // Pricing date
  ...
  /// </code>
	...
	/// <seealso cref="BaseEntity.Toolkit.Models.UniformBasketModel">Uniform Basket Model</seealso>
	///
  [Serializable]
	public class SyntheticCDOUniformPricer : SyntheticCDOPricer
  {
		// Logger
		private static readonly log4net.ILog logger=log4net.LogManager.GetLogger(typeof(SyntheticCDOUniformPricer));
    ...
    /// <summary>
		...
		///
    public
		SyntheticCDOUniformPricer(SyntheticCDO product,
															SyntheticCDOUniformPricer pricer,
    ...
    /// <summary>
		...
		///
    public
		SyntheticCDOUniformPricer( Dt asOf,
															 Dt settle,
															 ...
															 TimeUnit stepUnit )
			: base(product,
						 new UniformBasketPricer(asOf, settle, product.Maturity,
	...
	} // class SyntheticCDOUniformPricer
