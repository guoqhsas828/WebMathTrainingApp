...
namespace BaseEntity.Toolkit.Pricers
{
	...
	/// <see cref="BaseEntity.Toolkit.Models.SemiAnalyticCDOSquaredModel">Semi-analytic CDO2 Basket Model</see>.</para>
	/// </summary>
  /// <remarks>
  /// <inheritdoc cref="BaseEntity.Toolkit.Products.SyntheticCDO" />
  /// <para><h2>Pricing</h2></para>
  /// <inheritdoc cref="BaseEntity.Toolkit.Models.SemiAnalyticCDOSquaredModel" />
  /// </remarks>
  /// <seealso cref="BaseEntity.Toolkit.Products.SyntheticCDO">CDO of CDOs Tranche Product</seealso>
	/// <seealso cref="SemiAnalyticCDO2BasketPricer">Monte Carlo CDO2 Basket Pricer</seealso>
	/// <seealso cref="BaseEntity.Toolkit.Models.SemiAnalyticCDOSquaredModel">Monte Carlo CDO2 Basket Model</seealso>
	[Serializable]
	public class CDO2SemiAnalyticPricer : SyntheticCDOPricer
  {
		// Logger
		private static readonly log4net.ILog logger=log4net.LogManager.GetLogger(typeof(CDO2SemiAnalyticPricer));
    ...
    /// <summary>
		...
		/// </remarks>
		///
		/// <param name="product">CDOs tranche to price</param>
		...
		///
    public
		CDO2SemiAnalyticPricer( SyntheticCDO product,
														CDO2SemiAnalyticPricer pricer,
    ...
    /// <summary>
		...
		///
    public
		CDO2SemiAnalyticPricer( Dt asOf,
														Dt settle,
														...
														int sampleSize )
			: base(product,
						 new SemiAnalyticCDO2BasketPricer(asOf, settle, product.Maturity,
