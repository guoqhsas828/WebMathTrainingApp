...
{
	/// <summary>
	/// <para>Price a <see cref="BaseEntity.Toolkit.Products.FTD">Synthetic CDO</see> using the
	/// <see cref="BaseEntity.Toolkit.Models.HeterogeneousBasketModel">Heterogeneous Basket Model</see>.</para>
	/// </summary>
  /// <remarks>
  ...
  /// <note>This pricer is based on direct calculation of the loss distribution.</note>
  /// </remarks>
	/// <example>
	...
	///   FTDHeterogeneousPricer pricer =
	///     new FTDHeterogeneousPricer( asOf,                         // Pricing date
  ...
  [Serializable]
	public class FTDHeterogeneousPricer : FTDPricer
  {
		// Logger
		private static readonly log4net.ILog logger=log4net.LogManager.GetLogger(typeof(FTDHeterogeneousPricer));
    ...
    public
		FTDHeterogeneousPricer(FTD product,
    ...
    ///
    public
      FTDHeterogeneousPricer(Dt asOf,
                             Dt settle,
                             FTD product,
                             ...
                             TimeUnit stepUnit)
      : this(
        asOf, settle, product, discountCurve, null, survivalCurves, recoveryCurves, principals, copula, correlation,
        stepSize, stepUnit)
    {
    ...
    public
		FTDHeterogeneousPricer( Dt asOf,
                            ...
                            DiscountCurve referenceCurve,
														...
														TimeUnit stepUnit )
			: base(product,
						 new SemiAnalyticBasketForNtdPricer(asOf, settle, product.Maturity,
