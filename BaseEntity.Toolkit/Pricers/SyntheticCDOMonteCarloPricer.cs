/*
 * SyntheticCDOMonteCarloPricer.cs
 *
 *
 */
...
namespace BaseEntity.Toolkit.Pricers
{
  ///
	...
	///   <see cref="BaseEntity.Toolkit.Models.MonteCarloBasketModel">Monte Carlo Basket Model</see>.</para>
	/// </summary>
	///
  /// <remarks>
  /// <inheritdoc cref="BaseEntity.Toolkit.Products.SyntheticCDO" />
  /// <para><h2>Pricing</h2></para>
  /// <inheritdoc cref="BaseEntity.Toolkit.Models.MonteCarloBasketModel" />
  /// </remarks>
	///
	/// <example>
	...
	///                             0.30 );                           // Single correlation of 30%
	///
	///   // Create pricer for SyntheticCDO
	///   SyntheticCDOMonteCarloPricer pricer =
	///     new SyntheticCDOMonteCarloPricer( asOf,                   // Pricing date
  ...
  /// </code>
	...
	/// <seealso cref="SyntheticCDOHomogeneousPricer">Homogeneous CDO Pricer</seealso>
	/// <seealso cref="SyntheticCDOHeterogeneousPricer">Heterogeneous CDO Pricer</seealso>
	/// <seealso cref="BaseEntity.Toolkit.Models.MonteCarloBasketModel">Monte Carlo Basket Model</seealso>
	///
  [Serializable]
	public class SyntheticCDOMonteCarloPricer : SyntheticCDOPricer
  {
		// Logger
		private static readonly log4net.ILog logger=log4net.LogManager.GetLogger(typeof(SyntheticCDOMonteCarloPricer));
    ...
    /// <summary>
		...
		///
    public
		SyntheticCDOMonteCarloPricer(SyntheticCDO product,
																 SyntheticCDOMonteCarloPricer pricer,
    ...
    /// <summary>
		...
		///
    public
		SyntheticCDOMonteCarloPricer( Dt asOf,
																	Dt settle,
																	...
																	int sampleSize )
			: base(product,
						 new MonteCarloBasketPricer(asOf, settle, product.Maturity,
	...
	} // class SyntheticCDOMonteCarloPricer
