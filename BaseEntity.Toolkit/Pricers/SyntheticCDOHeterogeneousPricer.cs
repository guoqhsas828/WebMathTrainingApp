/*
 * SyntheticCDOHeterogeneousPricer.cs
 *
 *
 */
...
namespace BaseEntity.Toolkit.Pricers
{
  ...
  /// </remarks>
	...
	///     new SyntheticCDOHeterogeneousPricer( asOf,                // Pricing date
  ...
  /// </code>
	...
	/// <seealso cref="BaseEntity.Toolkit.Models.HeterogeneousBasketModel">Heterogenous basket model</seealso>
	///
  [Serializable]
	public class SyntheticCDOHeterogeneousPricer : SyntheticCDOPricer
  {
		// Logger
		private static readonly log4net.ILog logger=log4net.LogManager.GetLogger(typeof(SyntheticCDOHeterogeneousPricer));
    ...
    /// <summary>
		...
		///
    public
		SyntheticCDOHeterogeneousPricer(SyntheticCDO product,
																		SyntheticCDOHeterogeneousPricer pricer,
    ...
    /// <summary>
		...
		///
    public
		SyntheticCDOHeterogeneousPricer( Dt asOf,
																		 Dt settle,
																		 ...
																		 TimeUnit stepUnit )
			: base(product,
						 new HeterogeneousBasketPricer(asOf, settle, product.Maturity,
	...
	} // class SyntheticCDOHeterogeneousPricer
