/*
 * SyntheticCDO2SemiAnalyticPricer.cs
 *
 *
 */
...
namespace BaseEntity.Toolkit.Pricers
{
  ...
  /// </remarks>
	...
	///
  [Serializable]
	public class SyntheticCDO2SemiAnalyticPricer : SyntheticCDOPricer
  {
		// Logger
		private static readonly log4net.ILog logger=log4net.LogManager.GetLogger(typeof(SyntheticCDO2SemiAnalyticPricer));
    ...
    /// <summary>
		...
		///
    public
		SyntheticCDO2SemiAnalyticPricer(SyntheticCDO product,
    ...
    /// <summary>
		...
		///
    public
		SyntheticCDO2SemiAnalyticPricer( Dt asOf,
																		 Dt settle,
	...
	} // class SyntheticCDO2SemiAnalyticPricer
