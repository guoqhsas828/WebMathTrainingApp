...
namespace BaseEntity.Toolkit.Pricers
{
  ...
  /// </remarks>
	...
	///
  [Serializable]
	public class SyntheticCDO2MonteCarloPricer : SyntheticCDOPricer
  {
		// Logger
		private static readonly log4net.ILog logger=log4net.LogManager.GetLogger(typeof(SyntheticCDO2MonteCarloPricer));
    ...
    /// <summary>
		...
		///
    public
		SyntheticCDO2MonteCarloPricer(SyntheticCDO product,
    ...
    /// <summary>
		...
		///
    public
		SyntheticCDO2MonteCarloPricer( Dt asOf,
																	 Dt settle,
	...
	} // class SyntheticCDO2MonteCarloPricer
