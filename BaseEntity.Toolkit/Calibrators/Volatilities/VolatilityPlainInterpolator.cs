...
{
  /// <summary>
  ///   The plain interpolator of volatility surface.
  /// </summary>
  /// <remarks>
  ...
  ///   at the strike; then it performs time interpolation to get the volatility
  ///   at the given date.
  /// </remarks>
  [Serializable]
  public class VolatilityPlainInterpolator : IVolatilitySurfaceInterpolator
  {
    #region Constructors
    /// <summary>
    /// Initializes a new instance of the <see cref="VolatilityPlainInterpolator"/> class.
    /// </summary>
    public VolatilityPlainInterpolator()
    {
    ...
    public VolatilityPlainInterpolator(Interp strikeInterp, Interp timeInterp)
    {
