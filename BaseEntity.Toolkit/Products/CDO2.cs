...
{
  /// <summary>
  ///   Synthetic CDO of CDOs (CDO Squared)
  /// </summary>
  /// <remarks>
  ...
  ///   <para>For CDO of CDO, the underlying asset pool is a set of CDOs. Typically the
  ///   child CDOs have overlapping underlying reference assets. The child
  ///   CDOs pass through losses from the underlying asset pool. The parent CDO Squared
  ...
  ///   <h1 align="center"><img src="CDO2.jpg" width="50%"/></h1>
  ///   <para><h2>Pricing</h2></para>
  ///   <para>To price or calculate sensitivities for this product, a Pricer must be created.
  ///   A variety of pricing models are supported for this product including
  ///   <see cref="BaseEntity.Toolkit.Pricers.CDO2MonteCarloPricer">Monte Carlo</see> and
  ///   <see cref="BaseEntity.Toolkit.Pricers.CDO2SemiAnalyticPricer">Semi-Analytic</see>.</para>
  /// </remarks>
  /// <example>
  /// <para>The following example demonstrates constructing a CDO Squared tranche.</para>
  /// <code language="C#">
  ...
  ///
  ///   CDO2 cdo =
  ///     new CDO2( effectiveDate,                                  // Effective date
  ...
  public class CDO2 : Product
  {
    ...
    ///   All validation has been removed from the property methods and aggregated in the Validate 
    ///   function.
    /// </remarks>
    ///
    ...
    /// <summary>
    ///   True if cross-subordination between child CDOs
    /// </summary>
    [Category("Base")]
