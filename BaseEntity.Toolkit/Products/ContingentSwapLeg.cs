...
namespace BaseEntity.Toolkit.Products
{
  ...
  /// <summary>
  ///   ContingentSwapLeg product.
  /// </summary>
  /// <remarks>
  ///   The ContingentSwapLeg product implements fixed and floating rate
  ///   contingent swap legs.
  /// </remarks>
  [Serializable]
  [ReadOnly(true)]
  public class ContingentSwapLeg : Product
  {
    #region Constructors
    ...
    /// <summary>
    ///   Constructor for fixed contingent leg
    /// </summary>
    ///
    ...
    ///
    public
    ContingentSwapLeg(Dt effective, Dt maturity, Currency ccy, double coupon, DayCount dayCount,
    ...
    /// <summary>
    ///   Constructor for floating contingent leg
    /// </summary>
    ///
    ...
    public
    ContingentSwapLeg(Dt effective, Dt maturity, Currency ccy, double coupon, DayCount dayCount,
                      Frequency freq, BDConvention roll, Calendar cal, Tenor tenor, string index)
      : base(effective, maturity, ccy)
    {
      // Use properties for validation
      Coupon = coupon;
    ...
    public Tenor Tenor
    {
      get { return (tenor_.IsEmpty) ? new Tenor(freq_) : tenor_; }
      set { tenor_ = value; }
    }
    ...
    private double principal_ = 0.0;

    #endregion // Data

  } // class ContingentSwapLeg
