...
namespace StoreManager.Pages
{
  public static class MainMenu
  {
    ...
    {
      public const string PageName = "Test Group";
      public const string RoleName = "Test Group";
      public const string Path = "/TestGroup/Index";
      public const string ControllerName = "TestGroup";
      public const string ActionName = "Index";
    }

    public static class TestResult
    {
      public const string PageName = "Test Result";
      public const string RoleName = "Test Result";
      public const string Path = "/TestResult/Index";
      public const string ControllerName = "TestResult";
      public const string ActionName = "Index";
    }

    public static class TestImage
    {
      public const string PageName = "Test Image";
      public const string RoleName = "Test Image";
      public const string Path = "/TestImage/Index";
      public const string ControllerName = "TestImage";
      public const string ActionName = "Index";
    }

    public static class TestQuestion
    {
      public const string PageName = "Test Question";
      public const string RoleName = "Test Question";
      public const string Path = "/TestQuestion/Index";
      public const string ControllerName = "TestQuestion";
      public const string ActionName = "Index";
    }
  }
}
