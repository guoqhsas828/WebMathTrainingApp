...
namespace WebMathTraining.Controllers
{
  ...
  public class ManageController : Controller
  {
    ...
    private readonly IAppUserManageService _userProfileManager;
    ...
    public ManageController(
      ...
      IAppUserManageService userProfiles)
    {
    ...
    public async Task<IActionResult> Index()
    {
      ...
      var userProfile = await _userProfileManager.FindByUserEmail(user.Email);
      var model = new IndexViewModel(user, userProfile)
      {
    ...
    public async Task<IActionResult> Edit(IndexViewModel model)
    {
      ...
      var user = await _userManager.FindByEmailAsync(model.Email);//.GetUserAsync(User);
      if (user == null)
      {
      ...
      var experienceLevel = userProfile.ExperienceLevel;
      ...
      StatusMessage = $"Profile has been updated for {model.Username}";
    ...
    private string GenerateQrCodeUri(string email, string unformattedKey)
    {
      return string.Format(
          ...
          _urlEncoder.Encode("WebMathTraining"),
