...
namespace WebMathTraining.Views
{
    public class TestGroupsController : Controller
    {
      ...
      private readonly ITestSessionService _testSessionService;
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,TeamHeadId,MembersInfo,EnrolledSessionsInfo")] TestGroup testGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Description,TeamHeadId,MembersInfo,EnrolledSessionsInfo")] TestGroup testGroup)
        {
            if (id != testGroup.Id)
            {
                return NotFound();
